	...
	<section class="banner-bottom">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col left-blog-info-w3layouts-agileits text-left">
					<div class="blog-grid-top">
						<div class="b-grid-top">
							<div class="blog_info_left_grid">
								<a href="#">
									<img src="blogadmin/images/<?php echo $row['photo']; ?>" class="img-fluid" alt="image not available" style="width:100%;height:300px">
								</a>
							</div>
